...
namespace TemplateNet6.Infrastructure.Repositories
{
    public class EmpresaRepository: IEmpresaRepository
    {
        ...
        #region CONSTRUCTOR
        public EmpresaRepository(IDbConnectionService dbConnectionService)
        {
        ...
        public async Task<Empresa> GetEmpresaAsync(int idEmpresa)
        {
            ...
            return await connection.QuerySingleAsync<Empresa>("ConsultarEmpresa", parameters, commandType: CommandType.StoredProcedure);
